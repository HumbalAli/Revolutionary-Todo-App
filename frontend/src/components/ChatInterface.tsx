      ...
      <div className="p-8 border-t border-white/5 bg-black/60 relative">
        ...
        <form onSubmit={handleSendMessage} className="relative group">
          <input
            ...
            className="w-full pl-6 pr-14 py-4 bg-white/5 border border-white/10 rounded-2xl focus:outline-none focus:border-blue-500/40 text-sm text-white placeholder:text-gray-600 transition-all font-light"
            disabled={isLoading}
          />
          <button
            type="submit"
